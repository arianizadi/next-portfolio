  ...
  return (
    <main id='home'>
      ...
      <div className="flex flex-col items-center text-center justify-center w-full h-screen">
        <img className='absolute blur-[0px] h-[200px] -z-10 top-[60%] md:top-[50%] md:left-[10%] brightness-75' id='astro' src="/astro.png" alt='astronaut model'></img>
        <img className='absolute blur-[0px] h-[250px] md:h-[600px] -z-10 bottom-[50%] md:bottom-[30%] md:right-[5%] brightness-75' id='sat' src="/sat.png" alt='astronaut model'></img>
