  ...
  return (
    <main id='home'>
      ...
      <div className="flex flex-col items-center justify-center w-full h-screen">
        <Image className='absolute -z-10 top-[60%] md:top-[50%] md:left-[10%] brightness-75' id='astro' src="/astro.png" width={200} height={200} alt='astronaut model'></Image>
        <Image className='absolute -z-10 bottom-[50%] md:bottom-[30%] md:right-[5%] brightness-75' id='sat' src="/sat.png" width={500} height={200} alt='astronaut model'></Image>
